...
export default function Lienhe() {
  ...
  return (
    <div>
      ...
      <div className="container1 mb-[30px] contact mx-auto max-w-6xl">
                ...
                >
                  <div className="contact_fr">
                    ...
                    >
                      ...
                      <input
                        type="hidden"
                        id="Token-569583b56dae4588bccc3114ce800db0"
                        name="Token"
                      ...
                      <div
                        id="emtry_contact"
                        className="form-signup form_contact clearfix"
                      >
