...
export default function CheckAuth() {
  ...
  const [activeTab, setActiveTab] = useState<
    "info" | "orders" | "orderdetail" | "changespass" | "addressuser"
  >("info");
          ...
          <div className="rows">
            <div className="col-xs-12">
              ...
              <ul className="breadcrumb">
                ...
                <li>
                  <strong>
                    <span> Tài khoản của {user?.name}</span>
                  </strong>
                </li>
              </ul>
            </div>
          ...
          <div className="rows">
              ...
              <div className="col-xs-12 col-sm-12 col-lg-9 col-right-ac">
                ...
                <div className="form-signup name-account text-[14px]">
                  ...
                  {user.addresses?.address ? (
                    ...
                    <p>
                      <strong>Địa chỉ:</strong> Không có địa chỉ
                    </p>
                  )}
                </div>
                <button
            ...
            {activeTab === "orders" && (
              <div className="col-xs-12 col-sm-12 col-lg-9 col-right-ac">
                ...
                <div
                  className="table-responsive-block"
                                ...
                                <span className="span_">
                                  {order.cartitem.length > 0
                                    ? Number(order.cartitem[0].status_way) === 0
                                      ? "Chưa vận chuyển"
                                      : Number(order.cartitem[0].status_way) ===
                                        1
                                      ? "Đang vận chuyển"
                                      : "Đã tới nơi"
                                    : "Không có sản phẩm"}
                              ...
                              <td>
                                ...
                                Number(order.cartitem[0].status) === 0 ? (
                                  <button
                                    ...
                                    onClick={() =>
                                      handleHuyDonHang(order.cart_id)
                                    }
                                  >
                                    Huỷ đơn
                                  </button>
                ...
                return (
                  <div className="col-xs-12 col-sm-12 col-lg-9 col-right-ac hi">
                    <div className="title-head clearfix">
                      <h1>
                        Chi tiết đơn hàng <span>#{selectedOrder.ma_dh}</span>
                      </h1>
                            ...
                            <strong>
                              <em>
                                {selectedOrder.cartitem.length > 0
                                  ? Number(selectedOrder.cartitem[0].status) ===
                                    3
                                    ? "Đã huỷ"
                                    : Number(
                                        selectedOrder.cartitem[0].status
                                      ) === 0
                                    ? "Chưa thanh toán"
                                    : "Đã thanh toán"
                                  : "Không có sản phẩm"}
                    ...
                    <div className="shipping_status">
                      ...
                      <span className="span_" style={{ color: "red" }}>
                        <strong>
                          <em>
                            {selectedOrder.cartitem?.length > 0
                              ? Number(selectedOrder.cartitem[0].status_way) ===
                                0
                                ? "Chưa vận chuyển"
                                : Number(
                                    selectedOrder.cartitem[0].status_way
                                  ) === 1
                                ? "Đang vận chuyển"
                                : "Đã tới nơi"
                              : "Không có sản phẩm"}
                        ...
                        <div className="box-address">
                          ...
                          <div className="address box-des">
                            ...
                            <p>
                              ...
                              {selectedOrder.user.addresses?.[0]?.address ||
                                "Chưa có địa chỉ"}
                            </p>
                            <p>
                    ...
                    addresses.map((item, index) => (
                      ...
                      >
                        ...
                        >
                          ...
                          <div
                            id={`tool_address_${item.address_id}`}
                      ...
                      <div className="form_address">
                        ...
                        <div className="checkbox">
                          ...
                          <input
                            ...
                            value={"true"}
                          />
                          <span className="c-indicator text-[14px] text-center my-[1px]">
